# S-0046: Treatment Record Logging
...
- [ ] Integration with weather data (S-0050) for wind/temperature auto-fill?
- [ ] Customer notice generation (see S-0047) — required in many states within 24 hours of application
