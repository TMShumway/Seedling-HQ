# S-0039: On-My-Way + Job Completion Auto-Texts
...
- Use message templates (S-0038) for the content, with visit-specific variables
...
- ETA estimation: if route data available (S-0036), include estimated arrival time in the "on my way" message
