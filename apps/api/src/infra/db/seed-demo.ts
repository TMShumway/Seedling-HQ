 ...
 * Prereqs: db:reset → db:push (same as E2E seed)
 *
 * Uses ID range 00000000-0000-0000-0000-00000000{1400+} to avoid collisions
 * with E2E seed data (which uses 0xxx range).
 * Reuses same tenant (…0001), users (…0010–0014), categories, and service items.
 */
import pg from 'pg';
