...
- Reports accessible from Reports nav section (alongside revenue reports from S-0039)
- Export: PDF and CSV formats for state submission
- Client Hub integration: treatment records visible in service history (S-0050) if the client hub is implemented
