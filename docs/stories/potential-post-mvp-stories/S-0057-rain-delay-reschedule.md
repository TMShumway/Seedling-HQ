...
- Notifications: auto-send reschedule notifications to affected clients (uses templates from S-0044)
- Recurring service awareness: if the visit is part of a recurring agreement (S-0033), adjust the cadence or add a makeup visit
