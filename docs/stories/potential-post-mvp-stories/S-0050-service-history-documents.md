# S-0050: Service History + Document Access
...
- Service History tab on Client Hub:
  ...
  - Click to expand: full visit details, line items, photos (if S-0049 done)
...
- Documents section:
  ...
  - Service agreements (if S-0033 done) with current status
...
- [ ] Should chemical treatment records (S-0052) appear here for compliance?
