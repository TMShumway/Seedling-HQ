...
- `UserRepository` (includes `getOwnerByTenantId` for notification recipient lookup, `listActiveByEmail` for cross-tenant login, `getByIdGlobal(id)` for cross-tenant user lookup by ID, S-0027/S-0030)
